...
- [Routing](/guides/routing) -- detailed routing guide with advanced patterns
- [Layouts](/guides/layouts) -- nested layouts and layout boundaries
- [Middleware](/guides/middleware) -- request interception and the onion model
- [API Endpoints](/guides/api-endpoints) -- building HTTP handlers with endpoint files
- [Server Functions](/guides/server-functions) -- RPC-style server calls from client components
