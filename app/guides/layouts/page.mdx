...
- [Routing](/guides/routing) -- file-based routing, dynamic segments, and route priority
- [Middleware](/guides/middleware) -- intercept requests before they reach layouts and pages
