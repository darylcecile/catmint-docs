...
> For application-wide CORS, consider adding CORS headers in a middleware file rather than repeating them in every endpoint. See the [Middleware guide](/guides/middleware) for details.
...
- [Middleware](/guides/middleware) -- add authentication, logging, and CORS globally
- [Caching](/guides/caching) -- cache endpoint responses with cachedRoute
- [Server Functions](/guides/server-functions) -- RPC-style calls as an alternative to REST endpoints
