...
- [Server Functions](/guides/server-functions) -- RPC-style server calls with createServerFn
- [Caching](/guides/caching) -- cache route data and server responses
- [Static Assets](/guides/static-assets) -- serving images, fonts, and other static files
