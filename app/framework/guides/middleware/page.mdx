...
- [Layouts](/framework/guides/layouts) -- layout chains and persistence across navigation
- [Server Functions](/framework/guides/server-functions) -- call server-side code directly from components
- [API Endpoints](/framework/guides/api-endpoints) -- define HTTP handlers with endpoint files
