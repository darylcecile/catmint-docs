...
- [Routing](/framework/guides/routing) -- file-based routing and URL patterns
- [React Server Components](/framework/guides/rsc) -- import assets in server and client components
- [Caching](/framework/guides/caching) -- cache headers and CDN configuration
