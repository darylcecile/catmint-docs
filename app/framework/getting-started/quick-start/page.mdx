...
- [Project Structure](/framework/getting-started/project-structure) -- learn about file conventions and directory layout
- [Routing](/framework/guides/routing) -- dynamic segments, catch-all routes, and route groups
- [Server Functions](/framework/guides/server-functions) -- call server-side code directly from components
- [Middleware](/framework/guides/middleware) -- intercept requests with the onion execution model

[Next: Project Structure →](/framework/getting-started/project-structure)
